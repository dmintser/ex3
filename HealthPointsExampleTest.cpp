...
static bool checkHealthPointsValues(const HealthPoints &healthPoints,
                                    int current, int max) {
...
bool testComparisonOperators() {
  ...
  HealthPoints healthPoints1 =
      HealthPoints(100);            /* has 100 points out of 100 */
...
bool testOutputOperator() {
  ...
  HealthPoints healthPoints2 =
      HealthPoints(150);           /* has 1500 points out of 150 */
  healthPoints2 -= 50;             /* now has 100 points out of 150 */
